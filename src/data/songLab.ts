...
export const commonTabLicks: TabLick[] = [
  {
    id: "starter",
    nameHe: "הכי בסיסי — 5 תווים",
    descriptionHe: "זה מה שרוב הגיטריסטים מתחילים איתו. שמע → חזור.",
  ...
  {
    id: "short",
    nameHe: "קצר וקליט — 3 תווים",
    descriptionHe: "מושלם לאלתור: נגן → שקט → נגן שוב.",
    whenHe: "כשאתה מתחיל לאלתר. 3 תווים בלבד.",
    positions: [
      { stringIndex: 0, fret: 5 },
      { stringIndex: 0, fret: 8 },
      { stringIndex: 1, fret: 5 },
  ...
  },
  {
    id: "descend",
    nameHe: "יורד למטה",
    descriptionHe: "נשמע כמו סיום משפט מוזיקלי.",
    whenHe: "לפני שהאקורד מתחלף — 'נחיתה'.",
    positions: [
      { stringIndex: 2, fret: 5 },
      { stringIndex: 1, fret: 7 },
      { stringIndex: 1, fret: 5 },
  ...
  },
  {
    id: "high-e",
    nameHe: "על המיתר הדק",
    descriptionHe: "סולו גבוה וחד — Hendrix style.",
    whenHe: "כשהשיר מתנגן חזק — קופסה 1, מיתר e.",
    positions: [
...
export const improvRecipe = {
  ...
  steps: [
    ...
    "נגן שילוב 'קצר וקליט' (3 תווים)",
    "שקט 2 שניות",
    "עוד 3 תווים — אחרים",
    "כשהאקורד מתחלף — נסה פריט 5 על מיתר E (למטה)",
  ],
  goldenRule:
